import { Box, Button, Drawer, IconButton, Switch, Typography, useTheme } from "@mui/material";
 ...
 return (
    <div>
      <Box sx={{
        ...
        <ToolBarUser roleOptions={roleOptions} selectedUserIds={selectedUserIds} onClearSelection={clearSelectedUsers} setOpen={setOpen}/>
        {isLoading ? (
          <IsLoading />
        ) : errorMessage ? (
          <div>
          ...
          <Box sx={{ overflowX: "auto", width: "100%", minWidth: 0 }}>
            <Table isLoading={isLoading} data={users || []} 
